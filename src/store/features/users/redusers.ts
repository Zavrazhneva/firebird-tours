...
import { GET_USERS, GET_USERS_FAIL, GET_USERS_SUCCESS, UPDATE_USERS_QUERY } from './actions';
...
export const selectUsersLoading = (state: RootState): UsersState['usersLoading'] =>
  state.users.usersLoading;
export const selectSearchQuery = (state: RootState): UsersState['searchQuery'] =>
